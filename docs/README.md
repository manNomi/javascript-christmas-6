...
[] - event.apply()
[] - 예외 총주문 10000원 이상이면 이벤트 있음
[] - 이벤트의 resultEvent 값으로 할인 받을때마다 추가
[{event:"크리스마스",discount:3000}]
[] - 크리스마스 디데이 할인 함수 특정 날짜 기반 할인
[] - 평일 할인 - 디저트 메뉴 2023원 할인 함수
[] - 주말 할인 - 메인 메뉴 2023원 할인 함수
[] - 특별 할인 - 별있는 날 1000원 할인
[] - 증정 이벤트 - 할인 전 금액 12만원 이상시 샴페인
